...
const unfundedCount = unfundedList.length;

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = 
    `A total of $${amtRaised.toLocaleString('en-US')} has been raised for ${totalGames} games. Currently,
    ${unfundedCount} ${unfundedCount > 1 ? "games remain" : "game remains"}
    underfunded. We need your help to fund these amazing games!`
...
let [firstGame, secondGame] = [...sortedGames].slice(0,2);
